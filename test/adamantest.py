...
class ArchiveTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.ar = archive.Archive('../testdata/main')
    ...
    def test_data_loadin(self):
        ...
        compare_result = filecmp.dircmp('../testdata/main', '../testdata/expected/main')
        self.assertEquals(len(compare_result.diff_files), 0)

class ArchiveFinderTest(unittest.TestCase):

    def setUp(self):
        self.af = ArchiveFolder('../testdata')
...
class ArchiveExtractorTest(unittest.TestCase):
...
class ArchivePackerTest(unittest.TestCase):
